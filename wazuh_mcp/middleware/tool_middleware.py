    ...
    def tool(self, *args: Any, **kwargs: Any) -> Any:
        ...
        def capturing_decorator(fn: Any) -> Any:
            ...
            async def wrapped(*fn_args: Any, **fn_kwargs: Any) -> Any:
                ...
                from ..identity import record_injection_attempt, get_identity_key
                ...
                # No-op unless WAZUH_MCP_CONTEXT_GATING is enabled. Keeps inert
                # any tool whose context the caller has not entered.
                ...
                # Keyed per (caller, tool, args): if this exact call has failed
                # repeatedly, short-circuit before touching the backend.
                ...
                # A tool that returns {"error": ...} counts as a failure for the
                # breaker; any other shape resets the streak.
